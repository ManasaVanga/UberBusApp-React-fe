  ...
  handleReturnButton() {
    ...
    BookingServiceApi.modifyBooking(this.state.nextBooking).then(() => {
      this.setState({
        ...
        successMsg: "Bus has been returned! Thanks for using MZA Bus Share!",
        avaialbleReturn: false,
      });
    });
  }
    ...
    BookingServiceApi.getNextBooking()
      .then((res) => {
        if (Object.keys(res.data).length) {
          ...
          LocationServiceApi.getLocationFromId(res.data.location).then(
            (res) => {
              LocationServiceApi.getGeocodeFromAddress(res.data.address).then(
                (newRes) => {
